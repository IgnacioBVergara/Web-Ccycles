...
const nameCity = document.querySelector('#city'); //ciudad
const nameCountry = document.querySelector('#country'); //pais
...
form.addEventListener('submit', (e) => {
    ...
    //console.log(nombreCiudad.valor);
    //console.log(nombrePais.valor);
})
